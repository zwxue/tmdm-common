...
public interface ImpactAnalyzer {
    ...
    enum Impact {
        /**
         * A change that underlying storage may not be able to properly take into account <b>AND</b> will severely impact
         * the existing schema in a way that user won't be to query or update data.
         */
        HIGH,
        /**
         * <p>
         ...
         * medium change only indicates a change that still allows normal operation after the update (but doesn't guarantee
         * normal operation after later update(s)).
         * </p>
         */
        MEDIUM,
        /**
         * A change that underlying storage can properly take into account <b>AND</b> operations on storage
         * will not be altered (some useless elements may still exist in underlying storage).
         */
        LOW
    }
     ...
     * @see org.talend.mdm.commmon.metadata.compare.Compare#compare(org.talend.mdm.commmon.metadata.MetadataRepository, org.talend.mdm.commmon.metadata.MetadataRepository)
